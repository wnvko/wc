...
export default class MasterView extends LitElement {
  ...
  render() {
    return html`
      ...
      <igc-grid .data="${this.northwindEmployees}" primary-key="employeeID" display-density="cosy" allow-filtering="true" filter-mode="excelStyleFilter" auto-generate="false" width="925px" height="557px" class="ig-typography grid">
